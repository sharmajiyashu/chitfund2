            ...
            <div class="content-page">
                <div class="container-fluid add-form-list">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url('Dashboard/listCollateral');?>">Collateral  </a>&nbsp;&nbsp; > &nbsp;</li>
                        <li class="active"><?php if(isset($data['agent_id'])){ ?> Update Collateral <?php } else{?> Add Collateral <?php } ?></h4> </li>
                      </ul>
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="card">
