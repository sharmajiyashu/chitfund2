        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="container-fluid add-form-list">
                    ...
                    <li><a href="<?php echo base_url('Dashboard/EmployeesMasterList') ?>">Employee </a>&nbsp;&nbsp; > &nbsp;</li>
                    <li class="active"><?php if(!empty($data['master_employee_id'])){ ?>Update Employee<?php } else{ ?>
                                          Add Employee <?php } ?>  </li>
                  </ul> 
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="myform" action="<?php echo base_url(); ?>Dashboard/addEmployeesmaster" method="post" data-toggle="validator">
                                         ...
                                         <div class="row"> 
                                            ...
                                            <div class="col-md-6">                      
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter position" required  name="position" value="<?php echo isset($data['position']) ? $data['position'] : ''; ?>">
                                                    <div><font color='red'><?php echo form_error('fname'); ?></font></div>
                                                    <!--<div class="help-block with-errors"></div>-->
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-6">                      
                                                <div class="form-group">
                                                    <label>Salary*</label>
                                                    <input type="text" class="form-control" placeholder="Enter salary" required  name="salary" value="<?php echo isset($data['salary']) ? $data['salary'] : ''; ?>">
                                                    <div><font color='red'><?php echo form_error('fname'); ?></font></div>
                                                    <!--<div class="help-block with-errors"></div>-->
                                                </div>
                                            </div> 
