                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="myform" action="<?php echo base_url(); ?>Dashboard/addpayment" method="post" data-toggle="validator">
                                             ...
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="from" id="from">
                                                        ...
                                                        <option value="<?php echo isset($value['name']) ? $value['name'] : ''; ?>"><?php echo isset($value['name']) ? $value['name'] : ''; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
