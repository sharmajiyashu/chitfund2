        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="container-fluid add-form-list">
                    ...
                    <li><a href="<?php echo base_url('Dashboard/ExpensesListing'); ?>">Master Expenses </a>&nbsp;&nbsp; > &nbsp;</li>
                    <li class="active"><?php if(!empty($data['expense_id'])){ ?> Update Expenses 
                                          <?php } else{ ?>
                                          Add Expenses <?php } ?>  </li>
                  </ul> 
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="myform" action="<?php echo base_url(); ?>Dashboard/AddMasterExpenses" method="post" data-toggle="validator">
                                     
                                        <input type="hidden" name="id" value="<?php echo isset($data['expense_id']) ? $data['expense_id'] : '' ;  ?>" />  
                                        ...
                                        <?php if(!empty($data['expense_id'])){ ?> 
                                            <button type="submit" class="btn btn-primary mr-2" name="submit" value="submit"> Update Expenses  </button> 
                                        <?php } else{ ?>  
                                           <button type="submit" class="btn btn-primary mr-2" name="submit" value="submit">  Add Expenses  </button>
                                        <?php } ?>
