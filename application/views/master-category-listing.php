                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                                ...
                                <!--</div>-->
                            <div>
                                <a href="<?php echo base_url(); ?>Dashboard/MasterCategory" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Categree</a>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
                                                               href="<?php echo base_url(); ?>Dashboard/Editcategory/<?php echo isset($value['category_id']) ? $value['category_id'] : '';  ?>"><i class="ri-pencil-line mr-0"></i></a>
                                                      <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
                                                               href="<?php echo base_url(); ?>Dashboard/Deletecategory/<?php echo isset($value['category_id']) ? $value['category_id'] : '';  ?>"><i class="ri-delete-bin-line mr-0"></i></a>    
                                                    </td>
                                                </tr>
                                            <?php $i++; } ?>
                                        <?php } ?>
