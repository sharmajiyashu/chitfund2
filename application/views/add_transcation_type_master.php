        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="container-fluid add-form-list">
                    ...
                    <li><a href="<?php echo base_url('Dashboard/transaction_type_master_listing'); ?>">Transaction Type Master </a>&nbsp;&nbsp; > &nbsp;</li>
                    <li class="active"><?php if(!empty($data['transaction_type_master_id'])){ ?> Update Transcation Type <?php } else{ ?> Add Transcation Type <?php } ?>  </li>
                  </ul> 
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <?php if(!empty($data['transaction_type_master_id'])){ ?> 
                                        <h4 class="card-title">
                                          Update Transcation Type 
                                          <?php } else{ ?>
                                          Add Transcation Type 
                                        </h4>
                                       <?php } ?> 
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <form id="myform" action="<?php echo base_url(); ?>Dashboard/add_transcation_type_master" method="post" data-toggle="validator">
                                     
                                        <input type="hidden" name="id" value="<?php echo isset($data['transaction_type_master_id']) ? $data['transaction_type_master_id'] : '' ;  ?>" />  
                                        ...
                                        <?php if(!empty($data['transaction_type_master_id'])){ ?> 
                                            <button type="submit" class="btn btn-primary mr-2" name="submit" value="submit"> Update Transcation Type  </button> 
                                        <?php } else{ ?>  
                                           <button type="submit" class="btn btn-primary mr-2" name="submit" value="submit">  Add Transcation Type  </button>
                                        <?php } ?>
